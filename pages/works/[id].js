  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
        <div className="md:w-1/2 max-h-[700px]  "> {/* 设置高度并允许内容溢出 */}
          <h2 className="text-xl font-bold mb-2">代码：</h2>
          <div className="border rounded-md overflow-hidden"> {/* 添加边框和隐藏溢出 */}
            <CodeMirror // 使用 CodeMirror 组件
              value={work.code}
              extensions={[javascript({ jsx: true })]} // 设置语言为 JavaScript
              readOnly={false} // 设置为只读
              editable={true} 
              height="750px"
              basicSetup={{
